...
import auto.cursor.processor.AutoCursorBuilderProcessor;
...
public class CompilationTest extends TestCase {
  public void testCompilation() {
    ...
    // Most AutoCursor code-generation tests are functional, meaning that we check that the generated
    ...
    JavaFileObject expectedOutput = JavaFileObjects.forSourceLines(
        "foo.bar.AutoCursor_Baz",
        "package foo.bar;",
        "",
        "final class AutoCursor_Baz extends Baz {",
        "  private final int buh;",
        "",
        "  AutoCursor_Baz(int buh) {",
        "    this.buh = buh;",
        "  }",
        "",
  ...
  public void testImports() {
    ...
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new AutoCursor_Baz(ints, arrays);",
        "  }",
        "}");
    JavaFileObject expectedOutput = JavaFileObjects.forSourceLines(
        "foo.bar.AutoCursor_Baz",
        ...
        "",
        "  AutoCursor_Baz(int[] ints, Arrays arrays) {",
        "    if (ints == null) {",
        ...
        "    if (o instanceof Baz) {",
        "      Baz that = (Baz) o;",
        "      return (Arrays.equals(this.ints, (that instanceof AutoCursor_Baz) "
                      + "? ((AutoCursor_Baz) that).ints : that.ints()))",
  ...
  public void testNoMultidimensionalPrimitiveArrays() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new AutoCursor_Baz(ints);",
        "  }",
        "}");
    assertAbout(javaSource())
        .that(javaFileObject)
        .processedWith(new AutoCursorProcessor())
        .failsToCompile()
        .withErrorContaining("AutoCursor class cannot define an array-valued property "
  ...
  public void testNoObjectArrays() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new AutoCursor_Baz(strings);",
        "  }",
        "}");
    assertAbout(javaSource())
        .that(javaFileObject)
  ...
  public void testAnnotationOnInterface() throws Exception {
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoCursorProcessor())
        .failsToCompile()
        .withErrorContaining("AutoCursor only applies to classes")
  ...
  public void testExtendAutoCursor() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Outer",
        "package foo.bar;",
        "",
        ...
        "      return new AutoCursor_Outer_Parent(randomProperty);",
        "    }",
        "",
        ...
        "      return new AutoCursor_Outer_Child(randomProperty);",
        "    }",
        "",
        "    abstract int randomProperty();",
        "  }",
  ...
  public void testNonExistentSuperclass() throws Exception {
    // The main purpose of this test is to check that AutoCursorProcessor doesn't crash the
  ...
  public void testCannotImplementAnnotation() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new AutoCursor_RetentionImpl(policy);",
        "  }",
        "",
  ...
  public void testCorrectBuilder() throws Exception {
    ...
    JavaFileObject expectedOutput = JavaFileObjects.forSourceLines(
        ...
        "          && (Arrays.equals(this.aByteArray, "
                    + "(that instanceof AutoCursor_Baz) "
                        + "? ((AutoCursor_Baz) that).aByteArray : that.aByteArray()))",
        "          && (Arrays.equals(this.aNullableIntArray, "
                    + "(that instanceof AutoCursor_Baz) "
                        + "? ((AutoCursor_Baz) that).aNullableIntArray : that.aNullableIntArray()))",
        ...
        "      }",
        "      Baz<T> result = new AutoCursor_Baz<T>(",
  ...
  public void testAutoCursorBuilderOnTopLevelClass() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Builder",
        "package foo.bar;",
        "",
    ...
    assertAbout(javaSource())
        .that(javaFileObject)
        .processedWith(new AutoCursorProcessor(), new AutoCursorBuilderProcessor())
        .failsToCompile()
        .withErrorContaining("can only be applied to a class or interface inside")
        .in(javaFileObject).onLine(6);
  }

  public void testAutoCursorBuilderNotInsideAutoCursor() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
        ...
        "    return new AutoCursor_Baz.Builder();",
        "  }",
        "",
        "  @AutoCursor.Builder",
        "  public interface Builder {",
  ...
  public void testAutoCursorBuilderOnEnum() throws Exception {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoCursorBuilderDuplicate() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoCursorBuilderMissingSetter() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoCursorBuilderMissingSetterUsingSetPrefix() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoCursorBuilderWrongTypeSetter() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoCursorBuilderWrongTypeSetterWithGetPrefix() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoCursorBuilderExtraSetter() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoCursorBuilderSetPrefixAndNoSetPrefix() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoCursorBuilderAlienMethod() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoCursorBuilderMissingBuildMethod() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoCursorBuilderDuplicateBuildMethods() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoCursorBuilderWrongTypeBuildMethod() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoCursorBuilderTypeParametersDontMatch1() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoCursorBuilderTypeParametersDontMatch2() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoCursorBuilderTypeParametersDontMatch3() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoCursorBuilderToBuilderWrongTypeParameters() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoCursorBuilderToBuilderDuplicate() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoCursorValidateNotInAutoCursor() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
  ...
  public void testAutoCursorValidateWithoutBuilder() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
    ...
    assertAbout(javaSource())
        ...
        .failsToCompile()
        .withErrorContaining(
            "@AutoCursor.Validate is only meaningful if there is an @AutoCursor.Builder")
        .in(javaFileObject).onLine(10);
  }

  public void testAutoCursorBuilderValidateMethodStatic() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoCursorProcessor(), new AutoCursorBuilderProcessor())
        .failsToCompile()
        .withErrorContaining("@AutoCursor.Validate cannot apply to a static method")
        .in(javaFileObject).onLine(10);
  }

  public void testAutoCursorBuilderValidateMethodNotVoid() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoCursorProcessor(), new AutoCursorBuilderProcessor())
        .failsToCompile()
        .withErrorContaining("@AutoCursor.Validate method must be void")
        .in(javaFileObject).onLine(10);
  }

  public void testAutoCursorBuilderValidateMethodWithParameters() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoCursorProcessor(), new AutoCursorBuilderProcessor())
        .failsToCompile()
        .withErrorContaining("@AutoCursor.Validate method must not have parameters")
        .in(javaFileObject).onLine(10);
  }

  public void testAutoCursorBuilderValidateMethodDuplicate() {
    JavaFileObject javaFileObject = JavaFileObjects.forSourceLines(
        "foo.bar.Baz",
        "package foo.bar;",
        "",
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoCursorProcessor(), new AutoCursorBuilderProcessor())
        .failsToCompile()
        .withErrorContaining("There can only be one @AutoCursor.Validate method")
        .in(javaFileObject).onLine(13);
  }
  ...
  public void testGetFooIsFoo() throws Exception {
    ...
    assertAbout(javaSource())
        ...
        .processedWith(new AutoCursorProcessor())
        .failsToCompile()
        .withErrorContaining("More than one @AutoCursor property called foo")
        .in(javaFileObject).onLine(8);
  }

  private static class PoisonedAutoCursorProcessor extends AutoCursorProcessor {
    private final IllegalArgumentException filerException;

    PoisonedAutoCursorProcessor(IllegalArgumentException filerException) {
  ...
  public void testExceptionBecomesError() throws Exception {
    ...
    // AutoCursorProcessor or javac.
    // We inject an exception by subclassing AutoCursorProcessor in order to poison its processingEnv
    ...
    assertAbout(javaSource())
        .that(javaFileObject)
        .processedWith(new PoisonedAutoCursorProcessor(exception))
        .failsToCompile()
  ...
  public void testReferencingGeneratedClass() {
    // Test that ensures that a type that does not exist can be the type of an @AutoCursor property
    // as long as it later does come into existence. The BarFoo type referenced here does not exist
    // when the AutoCursorProcessor runs on the first round, but the FooProcessor then generates it.
    // That generation provokes a further round of annotation processing and AutoCursorProcessor
    // should succeed then.
    JavaFileObject bazFileObject = JavaFileObjects.forSourceLines(
        ...
        "    return new AutoCursor_Baz(barFoo);",
        "  }",
        "}");
    ...
    assertAbout(javaSources())
        ...
        .processedWith(new AutoCursorProcessor(), new FooProcessor())
        .compilesWithoutError();
  }
}

...
class AutoCursorTemplateVars extends TemplateVars {
  ...
  List<AutoCursorProcessor.Property> props;
  ...
  /**
   * The package of the class with the {@code @AutoCursor} annotation and its generated subclass.
   */
  String pkg;
  /**
   * The name of the class with the {@code @AutoCursor} annotation, including containing
   * classes but not including the package name.
   */
  String origClass;
  /** The simple name of the class with the {@code @AutoCursor} annotation. */
  String simpleClassName;
  /** The simple name of the generated subclass. */
  String subclass;

  /**
   * The formal generic signature of the class with the {@code @AutoCursor} annotation and its
   ...
   * builder type. If class {@code Address} contains {@code @AutoCursor.Builder} class Builder
   * then this will typically be {@code "Address.Builder"}.
   */
  String builderTypeName = "";

  /**
   * The formal generic signature of the {@code AutoCursor.Builder} class. This is empty, or contains
  ...
  /**
   * The simple names of validation methods (marked {@code @AutoCursor.Validate}) in the AutoCursor
   * class. (Currently, this set is either empty or a singleton.)
   */
  Set<String> validators = Collections.emptySet();

  private static final SimpleNode TEMPLATE = parsedTemplateForResource("autocursor.vm");
